...
class MantisEnemy(BasicMovement):
    ...
    def loadSprites(self):
        self.img0 = pygame.image.load('Sprites/EnemyMantis/sprite_enemymantis0.png')
        self.img1 = pygame.image.load('Sprites/EnemyMantis/sprite_enemymantis1.png')
