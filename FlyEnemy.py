...
class FlyEnemy(BasicMovement):
    ...
    def loadSprites(self):
        self.img0 = pygame.image.load('Sprites/EnemyFly/sprite_enemyfly0.png')
        self.img1 = pygame.image.load('Sprites/EnemyFly/sprite_enemyfly1.png')
